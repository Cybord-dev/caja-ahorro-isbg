...
public class ValidaTesoEvent extends AbstractEvent {
	private SolicitudDto solicitudDto;

	public ValidaTesoEvent(SolicitudDto solicitudDto) {
		super(EventFactoryTypeEnum.VALIDA_TESO.getState());
		this.solicitudDto = solicitudDto;
	}

	protected ValidaTesoEvent(String name) {
		super(name);
	}
