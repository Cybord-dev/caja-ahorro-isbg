...
--
-- Table structure for table `datos_user`
--

DROP TABLE IF EXISTS `datos_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `datos_user` (
  `id_datos_user` int NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_datos_user` (`id_datos_user`),
  UNIQUE KEY `DATOS_USER_ROLES_UNIQUE` (`id_usuario`,`tipo_dato`)
...
-- Dump completed on 2026-09-20 14:43:13
