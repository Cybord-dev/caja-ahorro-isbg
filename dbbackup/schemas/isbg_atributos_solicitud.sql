...
--
-- Table structure for table `atributos_solicitud`
--

DROP TABLE IF EXISTS `atributos_solicitud`;
...
CREATE TABLE `atributos_solicitud` (
  ...
  UNIQUE KEY `ATRIBUTOS_SOLICITUD_UNIQUE` (`id_solicitud`,`nombre`)
...
-- Dump completed on 2026-09-20 14:43:01
